...
DEVS = list(map(int, os.getenv("DEVS", "6016943381").split()))

API_ID = int(os.getenv("API_ID", "29984284"))

API_HASH = os.getenv("API_HASH", "c41d118adb5d91352aa6eac8586a3f00")

BOT_TOKEN = os.getenv("BOT_TOKEN", "7253197483:AAEqpze_IMfg4wpKcCrnLzEdD9yorCdAb9I")

OWNER_ID = int(os.getenv("OWNER_ID", "6016943381"))
...
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-1003051810060"))
